...
```javascript
** INFORMATION ****************************************************************
*   Routine Name : J_CACHE_CURRENCY.HELPER
*           Type : SUBROUTINE
*         Params : PROCESS.NAME
*            Loc : BP
** AUDIT **********************************************************************
...
<img src="../.resources/themes/unicons-line-6563ff/link.svg" alt="J_CACHE_VALUE.HELPER" width="25" />[J_CACHE_VALUE.HELPER](../DOCS.PAGE/J_CACHE_VALUE.HELPER.md)  
