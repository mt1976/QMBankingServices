...
```javascript
** INFORMATION ****************************************************************
*   Routine Name : U_TEST5
*           Type : PROGRAM
*         Params :
*            Loc : BP
** AUDIT **********************************************************************
*   Info Updated : 20210301 at 15.40.47 in DEV by root
...
<img src="../.resources/themes/unicons-line-6563ff/link.svg" alt="W_BUNDLE.GET" width="25" />[W_BUNDLE.GET](../DOCS.PAGE/W_BUNDLE.GET.md)  
