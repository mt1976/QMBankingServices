SELECT        {{SQL.SOURCE}}.Deals.SienaReference, {{SQL.SOURCE}}.Deals.CustomerSienaView, {{SQL.SOURCE}}.Deals.Status, {{SQL.SOURCE}}.Deals.StartDate AS ValueDate, {{SQL.SOURCE}}.Deals.MaturityDate, {{SQL.SOURCE}}.Deals.ContractNumber, {{SQL.SOURCE}}.Deals.ExternalReference, {{SQL.SOURCE}}.Deals.Book,
                         ...
                         RTRIM(LTRIM(LEFT({{SQL.SOURCE}}.Deals.CustomerSienaView, 10))) AS Firm, {{SQL.SOURCE}}.FundamentalDealType.DealTypeShortName, {{SQL.SOURCE}}.Deals.FullDealType, {{SQL.SOURCE}}.Deals.TradeDate, {{SQL.SOURCE}}.Deals.DealtCcy, {{SQL.SOURCE}}.Deals.DealtAmount, {{SQL.SOURCE}}.Deals.AgainstAmount,
                         {{SQL.SOURCE}}.Deals.AgainstCcy, {{SQL.SOURCE}}.Deals.AllInRate, {{SQL.SOURCE}}.Deals.MktRate, {{SQL.SOURCE}}.Deals.SettleCcy, {{SQL.SOURCE}}.Deals.Direction, {{SQL.SOURCE}}.Deals.NpvRate, {{SQL.SOURCE}}.Deals.OriginUser, {{SQL.SOURCE}}.Deals.PayInstruction, {{SQL.SOURCE}}.Deals.ReceiptInstruction, {{SQL.SOURCE}}.Deals.NIName,
                         CONCAT_WS('', NULL, {{SQL.SOURCE}}.Deals.DealtCcy, NULL, {{SQL.SOURCE}}.Deals.AgainstCcy) AS CCYPair, ISNULL(NULLIF ({{SQL.SOURCE}}.Deals.NIName, NULL), CONCAT_WS('', NULL, {{SQL.SOURCE}}.Deals.DealtCcy, NULL, {{SQL.SOURCE}}.Deals.AgainstCcy)) AS Instrument,
                         {{SQL.SOURCE}}.Portfolio.Description1 AS PortfolioName, {{SQL.SOURCE}}.DealRevaluation.Date AS RVDate, {{SQL.SOURCE}}.DealRevaluation.MarkToMarket AS RVMTM, {{SQL.SOURCE}}.Deals.CounterBook, Book_1.FullName AS CounterBookName,
