...
# bash /volume1/home/admin/pushover.sh -a alert -m %N -t "$(hostname -s) - Torrent Complete" -u http://europa:6880/gui/web/index.html -n "Open uTorrent"
# bash /volume1/home/admin/pushover.sh -a alert -m %N -t "$(hostname -s) - Torrent Complete" -u http://titan:8282/gui/ -n "Open uTorrent"

USER_TOKEN=uyosdopsu9wxxo7b264bmnnhbfz8nj

# YOUR APPS TOKENS / UPPERCASE NAME WITH _TOKEN (usage: "-a monitor" uses MONITOR_TOKEN)
MONITOR_TOKEN=a2tmwazxg4hwts2vp9fn58wt9292wv
BACKUP_TOKEN=a2tmwazxg4hwts2vp9fn58wt9292wv
ALERT_TOKEN=a2tmwazxg4hwts2vp9fn58wt9292wv
